...
AUTHORISED SCOPE: ONLY the two new files. AUDIT TARGET = COMMIT b43eb996817a7c958197db5e9a05fe40191028c3 (`git show --stat` adds exactly those two). Docs commits OUT OF SCOPE. No existing file modified.
