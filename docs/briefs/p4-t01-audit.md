...
AUTHORISED SCOPE: ONLY the two new files. AUDIT TARGET = COMMIT d7c20b85d4f94fd152602b04ad32e2c98a4a320b (`git show --stat` adds exactly those two). Docs commits OUT OF SCOPE. No existing file modified.
