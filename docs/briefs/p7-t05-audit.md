...
AUTHORISED SCOPE: ONLY the two new files. AUDIT TARGET = COMMIT 25c6cebed8d5d0ffd3ee0dd4980035ec25131fbf (`git show --stat` adds exactly those two). Docs commits OUT OF SCOPE. No existing file modified.
