...
AUTHORISED SCOPE: ONLY the two new files. AUDIT TARGET = COMMIT 7ec52016e9a60b390b0e0446b27369814ccc3855 (`git show --stat` adds exactly those two). Docs commits OUT OF SCOPE. No existing file modified.
