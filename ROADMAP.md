...
| | **-B** | Implement: localStorage save/load, onboarding tutorial (claim planet → housing → ore mine → offline reveal → map intro) | **Complete** — src/ui/save.ts + useGameState rehydrate/persist, hybrid save, real offline gap, 4-step tutorial, +33 tests, 159 total (d36ce5c) |
